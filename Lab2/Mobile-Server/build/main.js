...
protectedApiRouter.use('/items', _book__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
const broadcast = (userId, data) => {
  ...
  wss.clients.forEach(client => {
    if (client.readyState === ws__WEBPACK_IMPORTED_MODULE_0___default.a.OPEN && userId === client.user.id) {
...
module.exports = __webpack_require__(/*! D:\ANUL_3\PDM\Lab2\Mobile-Server\src/index.js */"./src/index.js");
